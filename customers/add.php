...
<?php include(HEADER_TEMPLATE); ?>
    ...
    <form action="add.php" method="post">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="txt_pessoa" placeholder="Search for..." value="<?php if(isset($_GET['pessoa'])){echo $_GET['pessoa'];}else{echo NULL;}?>">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search for..." value="<?php if(isset($_GET['id_permission'])){echo $_GET['id_permission'];}else{echo NULL;}?>">
                    <span class="input-group-btn">
                        <button class="btn btn-default" type="button" data-toggle="modal" data-target="#modal_permissao">Go!</button>
                    </span>
                </div><!-- /input-group -->
        ...
        <div class="modal fade bs-example-modal-lg" id="modal_permissao" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <?php 
                        require_once('function.php');
                        index('ID, DESCRICAO, ATIVO', 'PERMISSAO', '', '');
                    ?>
                    <table class="table table-condensed">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th width="auto">Descricao</th>
                                <th>Status</th>
                                <th>Opções</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if ($usuarios) : ?>
                                ...
                                <tr class="<?php if($users['ATIVO']){echo "success";}else{ echo "danger";} ?>">
                                        ...
                                        <td><?php if ($users['ATIVO']){echo '<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>';}else{echo '<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>';} ?></td>
                                        <td class="actions text-right">
                                            <a href="add.php?id_permission=<?php echo $users['ID']; ?>" data-target="#txt_pessoa" data-customer="<?php echo $users['ID']; ?>">
                                                Send! 
                                            </a>
                                        </td>
                                    </tr>
